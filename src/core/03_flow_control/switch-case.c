...
int main(void) {
    ...
    switch (choice) {
        ...
        default: // prints the logic below if user type this
            ...
            return 0; // exits the program since the user types is now in the 
                      // condition or 'case' in this case.
    }
 ...
 * SIDE NOTE
 * =========================================================
 * switch-cases are more simpler and easier to use depending 
 * on how your logic works since switch-cases can ONLY use a 
 * singular variable at a time (e.g. 1-9 or characters)
 * this is commonly used and found on simple calculators.
 *
 * also, the difference between if-else and switch-case lies 
 * on how its use, but in general switch-cases are better to 
 * use if you only need to do certain logic based on singular 
 * value or character and it is also better for readability.
 * ========================================================= */